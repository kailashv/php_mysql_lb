...
<table cellpadding="1" cellspacing="1" id="resultTable">
          ...
          <tbody>
				...
				$result = mysql_query("SELECT * FROM policy where combo LIKE '%".$userid."%'");
				...
				while($row = mysql_fetch_array($result))
				  {
					echo '<tr>';
					  ...
					  echo '<td><div align="center">'.'<a href=download.php?id=' . $row["content"] .'&amp;downloadby=argie>download</a>'.' | '.'<a rel="facebox" href=editpolicy.php?id=' . $row["pol_id"] .'><img src="images/b_edit.png" /></a>'.' </div></td>';
					echo '</tr>';
						}
						if ($_SESSION['SESS_FIRST_NAME']!="admin"){
